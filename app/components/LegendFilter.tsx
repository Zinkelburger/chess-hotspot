  ...
  return (
    <div
      ...
      className="w-full h-full bg-gray-100/90 border-t border-gray-200
                 flex flex-col gap-2 px-3 py-2 overflow-hidden"
    >
      {/* ─────────── 1) Category chips ─────────── */}
      <div className="flex items-center space-x-4 overflow-x-auto pr-2">
        {Object.entries(CategoryColors).map(([cat, color]) => {
          ...
          return (
            <button
              ...
              className={clsx(
                'flex items-center space-x-1 select-none px-2 py-0.5 rounded-full border whitespace-nowrap',
